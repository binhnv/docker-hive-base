...
g_hadoop_conf_dir="${HADOOP_CONF_DIR}"
g_mysql_connector_jar=${MYSQL_CONNECTOR_JAR}
g_hive_url="http://archive.apache.org/dist/hive/hive-${HIVE_VERSION}/apache-hive-${HIVE_VERSION}-bin.tar.gz"
...
function install_package {
    ...
    ln -s ${g_hive_conf_dir}/hive-site.xml ${g_hadoop_conf_dir}/hive-site.xml
}
